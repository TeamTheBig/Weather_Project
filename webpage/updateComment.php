...
<body>
    <div class="grids">
        ...
        <div class="grid-logo">
            <h1 id="logo">Modify your comment</h1>
            <p><br><b>You can modify your comment. <br>But, you have to remember your nickname and password</b> </P>
        ...
        <div class="grid-info">
            ...
            <form action="insertComment.php" method="POST">
                <p><b>If you want to modify your comment in this page, veritify your nickname and password</b><br><br>
